...
public abstract class AbstractUserServiceTest extends AbstractServiceTest {//abstract
...
//        User newUser = getNew();//new   User(null, "New", "new@gmail.com", "newPass", true, Collections.singleton(Role.USER))
//        User created = service.create(new User(newUser));
//        int createdId = created.id();
//        newUser.setId(createdId);
//        USER_MATCHER.assertMatch(created, newUser);
//        USER_MATCHER.assertMatch(service.get(createdId), newUser);
//    }
